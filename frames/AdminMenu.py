...
class AdminMenu(ctk.CTkFrame):
    def __init__(self, master: Any, **kwargs):
        ...
        self.topic_button = ctk.CTkButton(self, command=self.go_to_topic, text="Редактировать задания и типы",
                                                fg_color="#009900", height=60, width=330, border_width=3,
                                                border_color="#006600", corner_radius=5, text_color="#FFF",
                                                font=("Fira Sans Bold", 40), hover_color="#007D00")
        self.topic_button.grid(row=1, column=0, sticky="nw", padx=30, pady=[28, 28])
    ...
    def go_to_topic(self) -> NoReturn:
        ...
        editor_frame = frames.TopicList.TopicList(self.window_attribute, self.columns_names, border_width=15, border_color="#006600",
                                                         fg_color="#FFFFFF", corner_radius=30)
